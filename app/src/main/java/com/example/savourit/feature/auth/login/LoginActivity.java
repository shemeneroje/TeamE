...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Forgot Password TextView and set the click listener
        TextView passwordRedirectText = findViewById(R.id.passwordRedirectText);  // Forgot Password TextView
        passwordRedirectText.setOnClickListener(v -> {
            // Start ForgotPasswordActivity when clicked
        ...
        // Observers for login success and error
