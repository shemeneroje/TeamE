...
public class ForgotPasswordFragment extends Fragment {
    ...
    private LinearLayout backToLoginText;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LinearLayout resetPasswordButton = view.findViewById(R.id.reset_button);
        LinearLayout backToLoginText = view.findViewById(R.id.back_button);
